...
export default function MetricCard({ label, value, unit }: Props) {
  return (
    <div className="card hover:shadow-md transition-all duration-300">
      <p className="font-stenz text-xs uppercase tracking-widest text-muted-ink font-semibold">{label}</p>
      <p className="mt-2 font-ciberus text-2xl sm:text-3xl font-bold text-ink">
        {value ?? "—"}
